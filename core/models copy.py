...
class LoanType(models.Model):
    type = models.CharField(max_length=50, verbose_name="شكل السلف")
...
class CovenantType(models.Model):
    type = models.CharField(max_length=50, verbose_name="شكل العهد")
...
class ExpenseCategory(models.Model):
    category = models.CharField(max_length=50, verbose_name="فئة المصروف")
...
class RevenueCategory(models.Model):
    category = models.CharField(max_length=50, verbose_name="فئة الايراد")
...
class Covenant(models.Model):
    ...
    convenant_type = models.ForeignKey('ConvenantType', on_delete=models.CASCADE, related_name='convenants')
...
class FundRevenue(models.Model):
    ...
    category = models.ForeignKey('RevenueCategory', on_delete=models.CASCADE, related_name='revenue_categorys')
...
class FundExpense(models.Model):
    ...
    category = models.ForeignKey('ExpenseCategory', on_delete=models.CASCADE, related_name='expense_categorys')
...
class Client(models.Model):
    ...
    type = models.ForeignKey('ClientType', on_delete=models.CASCADE, related_name='clients')
    category = models.ForeignKey('ClientCategory', on_delete=models.CASCADE, related_name='clients')
    category = models.CharField(max_length=50, verbose_name="فئة العميل")
